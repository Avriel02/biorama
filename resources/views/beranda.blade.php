  ...
  @include ('/partials/navbar')
      ...
      <div class="container py-5">
        <div class="row g-5">
          ...
          <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
            ...
            <h1 class="display-5 mb-4">Lorem ipsum dolor sit</h1>
            <p class="mb-4">
                ...
                <div class="service-title">
                  <div class="service-title-name">
                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                      <a href="#" class="h4 text-white mb-0">lorem ipsum</a>
                    </div>
                    <a
                  ...
                  <div class="service-content pb-4">
                    <a href="#"
                      ><h4 class="text-white mb-4 py-3">lorem ipsum</h4></a
                    >
                    <div class="px-4">
                      <p class="mb-4">
            ...
            <div class="service-item">
              <div class="service-inner">
                ...
                <div class="service-title">
                  ...
                  <div class="service-content pb-4">
                    <a href="#"
                      ><h4 class="text-white mb-4 py-3">Lorem Ipsm</h4></a
                    >
                    <div class="px-4">
                      <p class="mb-4">
                        Lorem ipsum dolor sit amet consectetur, adipisicing
    ...
    <div class="container-fluid testimonial overflow-hidden pb-5">
      <div class="container py-5">
        ...
        >
          <div class="sub-style">
            <h5 class="sub-title text-primary px-3">Lorem ipsum sit dot</h5>
          </div>
